...
public class EventoUniversitario {
    ...
    public void crearActividad(String tipoAct, int idAct, String tituloAct, int cupo, boolean requiereNotebook, String disertantes, int nivel){
        ...
        if (tipoAct.equalsIgnoreCase("Curso")) {
